...
namespace Libraries.Standard_Assets.Editor.ImageEffects
{
    ...
    class DepthOfFieldDeprecatedEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (simpleTweakMode.boolValue)
            {
                focalPoint.floatValue = EditorGUILayout.Slider("Focal distance", focalPoint.floatValue, go.GetComponent<Camera>().nearClipPlane,
            ...
            {
                focalZDistance.floatValue = EditorGUILayout.Slider("Distance", focalZDistance.floatValue, go.GetComponent<Camera>().nearClipPlane,
                    go.GetComponent<Camera>().farClipPlane);
                EditorGUILayout.PropertyField(objectFocus, new GUIContent("Transform"));
